...
<body class="bg-gradient-default bg-yellow">
	<div class="container">
		<form:form action="/signup/resultid" method="post"
			modelAttribute="member">

			<div class="row justify-content-center" style="margin-top: 150px">
				<div class="card o-hidden border-0 shadow-lg my-5">
					<div class="page-header">아이디찾기</div>
					<br>
					<div class="info">가입 시 등록하신 이메일주소를 입력하세요.</div>
					<br> <br>
					<div class="row">
					...
					<div class="row">
						...
						<div class="col-md-2">
							...
							<button type="submit" class="btn btn-warning"
								onclick="nextButton_click()" id="nextButton">찾기</button>
						</div>
					</div>
				</div>
